...
uint8_t splitbyte_pack(uint8_t high, uint8_t low) {
    return (high << SPLITBYTE_BITS) | low;
}

uint8_t splitbyte_set_low(uint8_t splitbyte, uint8_t low) {
...
uint8_t splitbyte_set_high(uint8_t splitbyte, uint8_t high) {
...
uint8_t splitbyte_get(uint8_t splitbyte, uint8_t index) {
    return (splitbyte >> (index * SPLITBYTE_BITS)) & SPLITBYTE_MASK;
}

uint8_t splitbyte_get_high(uint8_t splitbyte) {
    return splitbyte >> SPLITBYTE_BITS;
}

uint8_t splitbyte_get_low(uint8_t splitbyte) {
